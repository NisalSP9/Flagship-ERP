<%-- 
    Document   : manage_supplier
    Created on : Jul 28, 2016, 10:12:05 AM
    Author     : NisalSP9
--%>
    ...
    <body class="cfs">
            ...
            <div class="container-fluid">
                ...
                <div>
                    <ul class="nav navbar-nav">
                        ...
                        <li  class="active"><a href="manage_supplier.jsp">Supplier</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="TitelRedSpec col-xs-12"><p class="LetterOnRed">Supplier</p></div>
