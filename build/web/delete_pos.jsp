<%-- 
    Document   : delete_pos
    Created on : Jul 22, 2016, 4:16:15 PM
    Author     : NisalSP9
--%>
    ...
    <body class="cfs">
            ...
            <div class="container-fluid">
                ...
                <div>
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="delete_pos.jsp">Remove</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="TitelRedSpec col-xs-12"><p class="LetterOnRed">Delete Purchase Order</p></div>
        ...
        <script>
            ...
            function goDelete(x) {
                ...
                if (confirm("Are you sure..!") === true) {
                    ...
                    document.location = "DeletePOS?posID=" + x;
