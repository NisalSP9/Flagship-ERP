<%-- 
    Document   : purchaseApp
    Created on : Jul 27, 2016, 9:11:25 AM
    Author     : NisalSP9
--%>

<%@page import="com.flagship.erp.service.impl.SupplierServiceImpl"%>
<%@page import="com.flagship.erp.service.SupplierService"%>
    ...
    <body onload="dateFun()" class="cfs">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="TitelRedSpec col-xs-12"><p class="LetterOnRed">Pending Purchase Approval Request</p></div>
                    ...
                    <table class="table table-striped" style=" white-space: nowrap;" border="1">
                        ...
                        <tbody>
                            ...
                            <% DatabaseResourceFactory factory = new DatabaseResourceFactory();
                                ...
                                ResultSet resultSet = serviceImpl.pendingPurApp(connection);
                                ...
                                <td>
                                    <select id="spn">
                                        ...
                                        <% DatabaseResourceFactory factory1 = new DatabaseResourceFactory();
                                            ...
                                            SupplierService serviceImpl1 = new SupplierServiceImpl();

                                            ResultSet resultSet1 = serviceImpl1.getSupplier(connection1);

                                            while (resultSet1.next()) {

                                        %>

                                        <option  value="<%=resultSet1.getString("id") +"`"+ resultSet1.getString("name")%>">
        ...
        <script type="text/javascript">
            ...
            function goApp(x) {
                ...
                unitPrice = prompt("Please enter unit price");

                if (unitPrice) {

                    document.location.href = 'PurchaseApp?id=' + x + '&date=' + curDate + '&spn=' + document.getElementById("spn").value + '&up=' + unitPrice;
