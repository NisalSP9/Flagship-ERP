<%-- 
    Document   : modified_purchase_app
    Created on : Jul 27, 2016, 10:57:37 AM
    Author     : NisalSP9
--%>
    ...
    <body class="cfs">
            ...
            <div class="container-fluid">
                ...
                <div>
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="modified_purchase_app.jsp">Modify</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="TitelRedSpec col-xs-12"><p class="LetterOnRed">Modify Purchase Approval Request</p></div>
                    ...
                    <table class="table table-striped" style=" white-space: nowrap;" border="1">
                        ...
                        <tbody>
                            ...
                            <tr>        
                                ...
                                <td> <button onclick="goApp(<%=resultSet.getString("pos_id")%>)">X</button></td>
        ...
        <script>
            function goApp(x) {
                ...
                if (confirm("Are you sure..!") === true) {
                    ...
                    document.location.href = 'CancelAppPurchase?id=' + x;
