<%-- 
    ...
    Created on : Jul 11, 2016, 4:28:04 PM
    Author     : NisalSP9
--%>
    ...
    <body class="cfs">
            ...
            <div class="container-fluid">
                ...
                <div>
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="update_employee.jsp">Modify</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="TitelRedSpec col-xs-12"><p class="LetterOnRed">Update Employee</p></div>
