<%-- 
    ...
    Created on : Jul 7, 2016, 2:54:46 PM
    Author     : NisalSP9
--%>
    ...
    <body class="cfs">
            ...
            <div class="container-fluid">
                ...
                <div>
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="manage_users.jsp">Users</a></li>
                    </ul>
                </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="TitelRedSpec col-xs-12"><p class="LetterOnRed">User</p></div>
