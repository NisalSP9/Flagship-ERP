<%-- 
    Document   : QTY_app_home
    Created on : Jul 25, 2016, 3:52:12 PM
    Author     : NisalSP9
--%>
     ...
     <nav class="navbar navbar-default" style="margin-bottom: 0px;">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="TitelRedSpec col-xs-12"><p class="LetterOnRed">QTY Approval</p></div>
        ...
        <div class="container">
            ...
            <div class="col-sm-2">
                ...
                <form action="modify_apped_qtys.jsp">                       
            ...
            <div class="col-sm-2">
                ...
                <form action="view_all_apped_qty.jsp">                       
