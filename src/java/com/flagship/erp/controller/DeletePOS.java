...
public class DeletePOS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            service.deleteOPs(connection, id);

            connection.close();

            RequestDispatcher dispatcher = req.getRequestDispatcher("delete_pos.jsp");
            ...
            Logger.getLogger(DeletePOS.class.getName()).log(Level.SEVERE, null, ex);
