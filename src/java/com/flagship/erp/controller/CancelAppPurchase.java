 ...
 * @author aDMIN
 */
public class CancelAppPurchase extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           boolean rst = service.cancelPurcApp(connection, id);
           
           if(rst){
           
               connection.close();
               
               RequestDispatcher dispatcher = request.getRequestDispatcher("modified_purchase_app.jsp");
