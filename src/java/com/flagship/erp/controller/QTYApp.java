 ...
 * @author aDMIN
 */
public class QTYApp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            POsService ops = new OPsServiceImpl();

            boolean rst = ops.QTYapp(connection1, id, date);

            if (rst) {

                connection1.close();
                RequestDispatcher dispatcher = request.getRequestDispatcher("QTYapp.jsp");
